...
const MobileListMenu = () => {
  ...
  return (
    ...
    >
      ...
      {user ? null : (
        <NotAuthItemMenuGroup handleItemSelectedType={handleItemSelectedType} />
      )}

      {/*****************  Alert Group *****************/}
      {!user ? null : (
        <AlertItemMenuGroup handleItemSelectedType={handleItemSelectedType} />
      )}

      {/*****************  Account Menu Group *****************/}
      {!user ? null : (
        <AccountItemMenuGroup handleItemSelectedType={handleItemSelectedType} />
      )}

      {/*****************  Most Popular Menu Group *****************/}
      <MostPopularItemMenuGroup
